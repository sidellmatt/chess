class Pawn < Piece
    ...
    def forward_steps
        steps = []
        steps << [self.pos[0] + self.forward_dir, self.pos[1]] if self.board.valid_pos([[self.pos[0] + self.forward_dir, self.pos[1]]]) && self.board.rows[self.pos[0] + self.forward_dir][self.pos[1]].color == nil
